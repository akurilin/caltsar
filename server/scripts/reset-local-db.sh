...
docker run -d --name=postgres13 -p 5432:5432 -v postgres-volume:/var/lib/postgresql/data -v "$(pwd)/sql":/alex -e POSTGRES_PASSWORD=password postgres:13.4 postgres -c log_statement=all && \
